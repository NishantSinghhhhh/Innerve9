...
const Hero = () => {
  ...
  const birds = [
    ...
    { 
      ...
      className: "relative -top-[1rem] left-[4.5rem] transform -translate-x-1/2 -translate-y-1/2" 
    },
    { 
      id: "white-bird", 
      src: White, 
      style: "top-[80%] left-[10%] bottom-[13%]", 
      className: "relative -top-[4rem] left-[5.5rem] transform -translate-x-1/2 -translate-y-1/2" 
    },
  ];
