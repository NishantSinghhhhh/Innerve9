  ...
  return (
    <div className="w-screen h-[61rem] md:h-[60rem] lg:h-[50rem] text-white">
      <div className="text-center py-6">
        ...
        <p className="text-gray-400 sm:text-[1.5rem] mt-2 text-[1rem] md:text-[2rem] font-angrybirds">
        ...
        <div className="w-full md:w-1/5 flex flex-col items-center mt-[3rem] gap-4 p-4 md:ml-[4rem] md:mr-[4rem]">
          {categories.map((category) => (
            <button
              ...
              transition-all duration-300 transform hover:scale-105 text-white relative
              ${selectedCategory === category ? "shadow-lg" : "hover:bg-transparent"}`}
              style={{
        ...
        <div className="w-full md:w-3/5 mx-auto p-4">
          <div className="space-y-4">
            {faqsData[selectedCategory].map((faq, index) => (
              ...
              >
                <div
                  className="flex justify-between s, items-center cursor-pointer transition-all duration-300 hover:text-pink-500"
                  onClick={() => toggleQuestion(index)}
                >
                  <span className="md:text-[2rem] md:mb-[1.5rem] md:mt-[1.5rem] text-left text-[1rem] font-semibold font-tthoves">
                    {faq.question}
                  </span>
                  <span
